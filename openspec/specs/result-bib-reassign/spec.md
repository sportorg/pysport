...
Specification for the "Change bib" feature in the result edit dialog, allowing a user to reassign a linked participant's bib number directly from the result editing workflow.
