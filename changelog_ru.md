...
+ Результаты эстафетных команд как во всероссйских соревнованиях (команды из разных регионов занимают места после команд из одного региона) ([#495](https://github.com/sportorg/pysport/issues/495))
