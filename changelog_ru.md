...
+ Доработана панель сплитов: добавлены отсечки старта и финиша; добавлены десятые/сотые доли секунд, если указана точность; уменьшен начальный размер панели
