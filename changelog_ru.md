...
+ Интеграция с мессенджером MAX для оповещений о результатах и ручной отправки из меню; настройки аналогичны Telegram, но без настройки темы в групповых чатах (Thread id)
