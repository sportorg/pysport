...
def toolbar_list():
    return [
        ...
        (config.icon_dir('sportident.png'), _('SPORTident readout'), 'SPORTidentReadoutAction', 'sportident'),
        (config.icon_dir('network-off.svg'), _('Teamwork'), 'TeamworkEnableAction', 'teamwork'),
