...
from PySide2.QtWidgets import QDialog, QDialogButtonBox, QFormLayout, QLabel, QTextEdit, QPushButton
...
class MarkedRouteDialog(QDialog):
    ...
    def init_ui(self):
        ...
        self.hint = QLabel(translate("Specify in each row all control codes separated by comma, e.g. '31,32'"))
